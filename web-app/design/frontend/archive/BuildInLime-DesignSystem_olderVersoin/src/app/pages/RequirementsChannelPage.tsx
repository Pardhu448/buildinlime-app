...
export function RequirementsChannelPage() {
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-12 bg-white border-b border-[#e5d4c1] flex items-center justify-between px-6">
          <div className="flex items-center gap-3 text-sm text-[#717182]">
            ...
            <span className="text-[#1e1e1e] font-medium">Requirements</span>
          </div>
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto px-20 py-12">
            ...
            <div className="flex items-center gap-3 mb-3">
              <NotebookPen className="w-6 h-6 text-[#976623]" />
              <h1 className="text-3xl font-bold text-[#1e1e1e]">
                Requirements
              </h1>
            </div>
            <p className="text-[#717182] mb-8">
              Place to discuss and specify the requirements for the
              foundation work
            </p>

            {/* Attachments section */}
            <div className="mb-8">
              <button className="flex items-center gap-2 text-[#717182] hover:text-[#976623] transition-colors">
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="flex items-center gap-2 px-3 py-1.5 text-sm text-[#717182] hover:text-[#1e1e1e] hover:bg-[#f0e5d8] rounded transition-colors">
              ...
              <div className="flex gap-3 mb-6">
                <div className="w-6 h-6 rounded-full bg-[#976623] flex items-center justify-center flex-shrink-0">
                  <span className="text-white text-xs font-bold">P</span>
                </div>
                <div className="flex-1">
                  <p className="text-sm text-[#717182]">
                    <span className="text-[#1e1e1e] font-medium">
                      partharoyce@gmail.com
                    </span>{" "}
                    created the issue · 2min ago
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Comment input */}
            <div className="bg-[#fdf8f2] border border-[#e5d4c1] rounded-lg p-4">
              <textarea
          ...
          <aside className="w-72 bg-[#fdf8f2] border-l border-[#e5d4c1] overflow-y-auto p-6">
            ...
            {/* Tasks */}
            <div>
              <p className="text-xs font-semibold text-[#ac7f5e] uppercase tracking-wider mb-3">Tasks</p>
              <div className="space-y-2">
                <button className="w-full flex items-center gap-2 text-left hover:bg-[#f0e5d8] px-2 py-1.5 rounded transition-colors">
                  <Circle className="w-4 h-4 text-[#717182]" />
                  <span className="text-sm text-[#1e1e1e]">Research</span>
                </button>
                <button className="w-full flex items-center gap-2 text-left hover:bg-[#f0e5d8] px-2 py-1.5 rounded transition-colors">
                  <Circle className="w-4 h-4 text-[#717182]" />
                  <span className="text-sm text-[#1e1e1e]">Initial Draft</span>
                </button>
              </div>
            </div>
          </aside>
