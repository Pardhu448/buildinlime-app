...
export function MyTasksNav() {
  ...
  return (
    <Link
      to="/my-tasks"
      className="w-full flex items-center gap-2 px-3 py-2 text-sm text-foreground hover:bg-icon-chip rounded transition-colors"
    >
      ...
      {myUnopenedTaskCount > 0 && (
        <span className="flex-shrink-0 inline-flex items-center justify-center min-w-[18px] h-[18px] px-1 rounded-full bg-primary text-white text-[10px] font-semibold">
