  ...
  return (
    ...
    >
      <input
        ...
        required
        autoFocus
        className="w-full text-sm px-2 py-1.5 border border-card-border rounded bg-white focus:outline-none focus:ring-1 focus:ring-[#976623] text-[#1e1e1e] placeholder:text-[#717182]"
      />
      <input
        type="text"
        value={description}
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex items-center gap-1.5 px-2 py-1.5 text-xs text-[#717182] border border-card-border rounded bg-white hover:bg-icon-chip transition-colors"
        >
      ...
      <div className="flex items-center gap-2 pt-1">
        <button
          ...
          className="px-3 py-1.5 text-xs bg-[#976623] text-white rounded hover:bg-primary-hover disabled:opacity-40 transition-colors"
        >
          Attach
        </button>
        <button
