...
import { myTasksCollection } from "@/src/application/collections/communication"
import { coerceBool } from "@/src/application/collections/_shared"
import { useSeen } from "./useSeen"

/**
 * The DrawerContent "My Tasks" badge: how many tasks assigned to me are still open
 * and arrived since I last opened My Tasks.
 *
 ...
 * leave), clearing the badge. Mirrors web's use-my-tasks-badge.ts.
 */
export function useMyTasksBadge() {
  ...
  // client writes, not on sync). A bare `!t.completed` would read the non-empty
  // string "false" as truthy and drop every open task, pinning the badge at 0.
